...
| 대상 토픽 | 관계 | 근거 |
|-----------|------|------|
| `study/learn/topics/useRef-렌더링-참조규칙/note.md` | 개념적 전제 | mountRef/updateRef의 구조적 차이, Concurrent Mode tearing — 본 워크스루의 패턴 3,4가 그 안전장치의 코드 구현 |
