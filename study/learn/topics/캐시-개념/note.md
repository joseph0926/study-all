...
| 대상 토픽 | 관계 | 근거 |
|-----------|------|------|
| `study/learn/topics/React-리렌더링-비용과-메모이제이션/note.md` | 캐시의 구체적 적용 사례 (하위 메커니즘) | useMemo/React.memo는 캐시 3요소(Key=deps, Storage=Fiber, Invalidation=deps 변경)의 구체적 인스턴스. Q1의 보편적 패턴 테이블에서 React 행에 해당 |
