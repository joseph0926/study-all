---
name: forge
description: 산발적 학습을 통합 멘탈모델 + 실전 판단 프레임워크로 결정화 — 통합 비유 + 핵심 원칙 + Q&A
argument-hint: "<skill> [scope]"
disable-model-invocation: true
allowed-tools: Read, Grep, Glob, Write, WebSearch, WebFetch, mcp__study__context_resolve, mcp__study__session_appendLog, mcp__study__progress_getPlan, mcp__study__review_getMeta
---

입력: `$ARGUMENTS` (예: `react`, `react rendering`, `learn`)
