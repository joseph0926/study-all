...
| # | 스킬 | 토픽 | 상태 | 연결 |
|---|------|------|------|------|
| 1 | react | Topic 1: react (공개 API) | ✅ 완료 | — |
| 2 | react | Topic 10: shared | 🔄 진행중 (Step 1/5) | — |
| 3 | react | Topic 11: scheduler | ⬜ 미시작 | — |
| ... | | | | |
...
| 날짜 | 스킬 | 토픽 | 세션 유형 |
|------|------|------|----------|
| 2026-02-19 | react | Topic-1-Shared | /learn (Step 1/5) |
| 2026-02-16 | react | Work-Loop | /learn (Step 3/5) |
| ... | | | |
...
1. **진행 상태**: 각 토픽의 완료/진행중/미시작 상태
2. **완료 이력**: 새 세션 기록 추가
3. **다음 액션**: 현재 상태 기반 재계산
4. **최종 갱신일**: 오늘 날짜
5. **새 토픽**: 개별 plan.md에 추가된 토픽이 있으면 Master Phase에 배치
